...
// i.e., when evaluating Qs 10-12, their responses are appearing as N/A for both sets of questions.
 ...
 * Honing in on cases that will be included in analysis-- 
 * if anyinconsistency == 1, we will not be including these Rs in our analysis of insurance Qs
 * Exploring these data that have a missing q9 and no inconsistencies. */
list q9* anyinconsistency q10* q11* q12* if q9missing == 1 & anyinconsistency != 1

/* Based on this exploration, it appears that many respondents simply skipped Q9, but answered
 * the other insurance questions. Based on this, 
 * will recode Q9 == 1 (have insurance) for any R who gave an answer for Q10 or 11 (but not Q12)
 * and will recode Q9 == 2 (no insurance) for any R answered any of Qs 12 (but not Qs 10 or 11).
...
// Also, leave out those who declare in Q13 that they "didn't haveinsurance at any point in past 12 months" ! (Almost forgot those)
...
count if (q9r == . & anyinconsistency != 1 & skippedpg3 == 1)
// n = 27. They all skipped all of page 3,
// therefore they belong in the N/A category when forcing Qs 10-12. 


// Generating a new recoded q9 missing, eliminating those 27 from being tallied as "missing"
gen q9rmissing = .
